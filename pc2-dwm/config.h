...
static const char normfgcolor[]     = "#f3f3c3";
static const char selbordercolor[]  = "#a35a67";
static const char selbgcolor[]      = "#383c4a";
static const char selfgcolor[]      = "#f3f3a3";
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,                       XK_Down,       spawn,          {.v = downvol } },
        { MODKEY|ControlMask,                       XK_Left, 	   spawn, {.v = brightnessup} },
        { MODKEY|ControlMask,                       XK_Right, 	   spawn, {.v = brightnessdown} },
};
